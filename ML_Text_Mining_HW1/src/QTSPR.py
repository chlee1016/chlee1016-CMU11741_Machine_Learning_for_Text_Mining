...
f = open("C:\\Users\\chlee\\PycharmProjects\\ML_Text_Mining_HW1\\hw1handout\\hw1-handout\\data\\QTSPR-U2Q1.txt",'w')
weighted_r = weighted_sum_r(r_topic,distro_dict,0)
...
f = open("C:\\Users\\chlee\\PycharmProjects\\ML_Text_Mining_HW1\\hw1handout\\hw1-handout\\data\\QTSPR-NS.txt",'w')
for i in range(38):
...
f.close()
print("QTSPR-NS time :", time.time() - start)
...
f = open("C:\\Users\\chlee\\PycharmProjects\\ML_Text_Mining_HW1\\hw1handout\\hw1-handout\\data\\QTSPR-WS.txt",'w')
for i in range(38):
  weighted_r = weighted_sum_r(r_topic,distro_dict,i)
  doc_relscore_list = get_doc_relscore_list(fname,i)
...
f.close()
print("QTSPR-WS time :", time.time() - start)
...
f = open("C:\\Users\\chlee\\PycharmProjects\\ML_Text_Mining_HW1\\hw1handout\\hw1-handout\\data\\QTSPR-CM.txt",'w')
for i in range(38):
  weighted_r = weighted_sum_r(r_topic,distro_dict,i)
  doc_relscore_list = get_doc_relscore_list(fname,i)
...
print("QTSPR-CM time :", time.time() - start)
